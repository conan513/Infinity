...
const std::string CustomSpellEntryfmt="pppppppppppppapappppppppppppppppppppppppppppppppappppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaapppppppppppapppaaapppppaaaaaaa";
