...
UPDATE `creature_template` SET `AIName` = 'NullAI' WHERE `entry` = 34777;
UPDATE `creature_template` SET `AIName` = 'NullAI' WHERE `entry` = 36355;
...
UPDATE `creature_template` SET `AIName` = 'NullAI' WHERE `entry` = 34778;
UPDATE `creature_template` SET `AIName` = 'NullAI' WHERE `entry` = 36356;
