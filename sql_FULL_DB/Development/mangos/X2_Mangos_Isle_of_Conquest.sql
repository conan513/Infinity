...
-- Alli Glaive Thrower
UPDATE creature_template SET vehicle_id = 447, iconName = 'vehichleCursor', faction_A = 3, faction_H = 3, ScriptName = '', AIName = '' WHERE entry IN (34802, 35419);

-- Horde Glaive Thrower
UPDATE creature_template SET vehicle_id = 447, iconName = 'vehichleCursor', faction_A = 6, faction_H = 6, ScriptName = '', AIName = '' WHERE entry IN (35273, 35421);
...
-- Horde Siege Engine
UPDATE creature_template SET powertype = 3, vehicle_id = 435, iconName = 'vehichleCursor', faction_A = 6, faction_H = 6, ScriptName = '',AIName = '' WHERE entry IN (35069, 35433);

-- Ally Siege Engine
UPDATE creature_template SET powertype = 3, vehicle_id = 435, iconName = 'vehichleCursor', faction_A = 3, faction_H = 3, ScriptName = '',AIName = '' WHERE entry IN (34776, 35431);

-- Ally/horde Siege Turret
UPDATE creature_template SET powertype = 3, iconName = 'Gunner', vehicle_id = 436, ScriptName = '',AIName = '' WHERE entry IN (34777, 35436, 36355, 36357);

-- Horde/Ally Flame Turret
UPDATE creature_template SET powertype = 3, iconName = 'Gunner', vehicle_id = 437, ScriptName = '',AIName = '' WHERE entry IN (34778, 35417, 36356, 36358);
